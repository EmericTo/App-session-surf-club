        ...
        <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <Card>
            <CardContent className="text-center py-12">
              ...
              <h3 className="text-lg font-semibold text-gray-900 mb-2">Utilisateur introuvable</h3>
      ...
      <header className="bg-white border-b border-gray-200">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="text-sm text-gray-600">
              {isOwnProfile ? 'Mon profil' : `Profil de ${profile.username}`}
            </div>
          </div>
        </div>
      </header>
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="text-center">
                <div className="text-2xl font-bold text-purple-600">
                  {sessions.reduce((acc, s) => acc + s.like_count, 0)}
                </div>
        ...
        <div className="mb-8">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">
            {isOwnProfile ? 'Mes sessions' : `Sessions de ${profile.username}`}
          </h2>
            ...
            <Card>
              <CardContent className="text-center py-12">
                ...
                <h3 className="text-lg font-semibold text-gray-900 mb-2">
                  {isOwnProfile ? 'Aucune session pour le moment' : 'Aucune session partagée'}
                </h3>
                <p className="text-gray-600">
                  {isOwnProfile 
                    ? 'Commencez à partager vos sessions de surf !' 
                    : 'Cet utilisateur n\'a pas encore partagé de sessions.'
                  }
                </p>
              </CardContent>
            </Card>
